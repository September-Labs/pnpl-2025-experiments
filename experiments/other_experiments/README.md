...
Curated catalog of non-winning architectures from the LibriBrain phoneme work. Each entry links to the copied implementation and, when available, to the matching training configuration pulled from `ihor/competitions/libribrain_phoneme_classification`.
