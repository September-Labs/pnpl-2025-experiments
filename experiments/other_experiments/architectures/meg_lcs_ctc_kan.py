"""
Enhanced MEG LCS-CTC v4 with KAN integration
"""
...
# ============================================
# Enhanced MEG LCS-CTC Model v4 with KAN
# ============================================
...
class EnhancedMEGLCSCTCKAN(L.LightningModule):
    ...
    def configure_optimizers(self):
        ...
        # Collect non-KAN parameters
        other_params = []
        for name, param in self.named_parameters():
            if id(param) not in kan_param_ids:
    ...
    def on_train_epoch_end(self):
        """Update KAN grids at the end of each epoch for better adaptation."""
        if hasattr(self, 'classifier') and isinstance(self.classifier, KANClassifier):
            # Optionally update KAN grids based on training data statistics
            # This helps KAN layers adapt to the data distribution
            pass
